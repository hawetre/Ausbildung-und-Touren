<?php
    ...
    class Template {
        ...
        public function getNeu_KopierenAngebotTemplate() {
            $pathfile = '../MVC/Views/Templates/neu_kopierenAngebotTemplate.html';
            return ($this->neu_kopierenAngebotTemplate = file_get_contents($pathfile));
        }
        ...
        public function getAuswaehlenEigenesAngebot() {
            $pathfile = '../MVC/Views/Templates/auswaehlenEigenesAngebot.html';
            return ($this->htmlExportTemplate = file_get_contents($pathfile));
        }
